...
import { CreateSubAccount } from "./_components/create-sub-account";
interface PageProps {
  params: {
    agencyId: string;
  };
        ...
        <Command className="rounded-lg bg-transparent">
          ...
          <CommandGroup heading="Sub Accounts">
            {!!user.Agency?.SubAccount.length ? (
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDescription className="text-left">
                        This action cannot be undone. This will delete the subaccount and all data related to the
                        subaccount.
                      </AlertDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter className="flex items-center">
                      ...
                      <AlertDialogAction className="bg-destructive hover:bg-destructive">
                        <DeleteButton subaccountId={subaccount.id} subaccountName={subaccount.name} />
                      </AlertDialogAction>
                    </AlertDialogFooter>
                  </AlertDialogContent>
                </CommandItem>
              ...
              <p className="text-muted-foreground text-center p-4">No Sub accounts</p>
            )}
          </CommandGroup>
        </Command>
      </div>
