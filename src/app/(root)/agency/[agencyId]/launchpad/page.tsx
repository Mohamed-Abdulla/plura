...
const Page: FC<PageProps> = async ({ params: { agencyId }, searchParams: { code } }) => {
          ...
          <CardContent className="flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center w-full border p-4 rounded-lg gap-2">
              ...
              {allDetailsExist ? (
                ...
                <Link className="bg-primary py-2 px-4 rounded-md text-white" href={`/agency/${agencyId}/settings`}>
                  Start
                </Link>
              )}
            </div>
