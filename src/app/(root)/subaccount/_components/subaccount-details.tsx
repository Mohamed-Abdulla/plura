...
import { upsertSubAccount } from "@/actions/subaccount.actions";
import { useModal } from "@/hooks/use-modal";
import { toast } from "sonner";
import { subaccountDetailsFormSchema } from "@/schemas";
...
export const SubAccountDetails: React.FC<SubAccountDetailsProps> = ({ details, agencyDetails, userId, userName }) => {
  ...
  async function onSubmit(values: z.infer<typeof subaccountDetailsFormSchema>) {
    try {
      ...
      toast.info("Subaccount details saved", {
